...
خروجی اصلی به صورت یک نوت‌بوک قابل اجرا در JupyterLab و نسخهٔ HTML آن است:

- نوت‌بوک: `04-05-Kmeans-HAC.ipynb`
- خروجی HTML: `04-05-Kmeans-HAC.html`

تصاویر نمودارهای اصلی نیز در پوشهٔ `images/` ذخیره شده‌اند:

- `images/01.png`: نمودارهای مرتبط با K-means (تابع هزینه و سرعت همگرایی)
- `images/02.png`: مقایسه تابع هزینه K-means و HAC برای Kهای مختلف
...
برای اجرای پروژه در JupyterLab:

1. به پوشهٔ پروژه بروید:

   ```bash
   cd "d:\\Programming\\ML Project for College\\machine-learning-portfolio\\04-05-K-means-HAC"
   ```

2. JupyterLab را اجرا کنید:

   ```bash
   jupyter lab
   ```

3. نوت‌بوک `04-05-Kmeans-HAC.ipynb` را باز و سلول‌ها را از بالا به پایین اجرا کنید.
